    ...
    useEffect(() => {
        ...
        if (reviews && reviews.length > 0) {
            reviews.forEach((review) => {
                ...
                cafeStats.noise_rating +=
                    noiseLevels_inverse[review.noise_level];
        ...
        if (cafeStats.num == 0)
            ...
            cafeStats = {
                ...
                outlet_rating:
                    Math.round(
                        (cafeStats.outlet_rating / cafeStats.num) * 100
                    ) / 100,
                ...
                noise_rating:
                    ...
                    Math.round(cafeStats.noise_rating / cafeStats.num)
                        ? noiseLevels[
                              cafeStats.noise_rating / cafeStats.num - 1
                          ]
                ...
                overall_rating:
                    Math.round(
                        (cafeStats.overall_rating / cafeStats.num) * 100
                    ) / 100,
            };
        }
        ...
        <div className="bg-accent-3 m-3 rounded-xl">
            ...
            <div className="flex justify-center items-center pb-3">
                <button
                    ...
                    onClick={() =>
                        (window.location.href = `/${place.place_id}/review`)
                    }
                >
                    Leave a review
                </button>
