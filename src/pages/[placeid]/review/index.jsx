...
import { handleReviewFormSubmission } from "../../../app/actions";
...
export default function Review() {
    ...
    const validateForm = () => {
        ...
        if (
            !["Very Quiet", "Quiet", "Medium", "Loud", "Very Loud"].includes(
                noise
            )
        ) {
            errors.push(
    ...
    const handleSubmit = (event) => {
        ...
        if (errors) {
            handleReviewFormSubmission(placeid, {
    ...
    return (
        <div className="bg-accent-1 flex font-short-stack inset-0 justify-center items-center overflow-y-auto">
            <div className="m-auto p-10 rounded-lg w-auto rounded-md h-auto">
                <h1 className="text-2xl font-bold text-accent-6">
                    {place.name}
                </h1>
                    ...
                    <div className="flex items-center text-sm">
                        {[
                            ...
                            <div key={index} className="flex items-center mr-4">
                                ...
                                />
                                <span className="ml-2 text-accent-6">
                                    {label}
                                </span>
                            </div>
                        ))}
